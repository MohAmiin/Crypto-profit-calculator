...
<body>
    <div class="container">
        <header>
            ...
            <p class="tagline">Calculate your potential cryptocurrency gains and losses with our easy-to-use calculator</p>
        </header>
        ...
        <div class="main-content">
            <div class="calculator-card">
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="investment" placeholder="Enter amount in USD" value="0">
                </div>
                
                <div class="input-group">
                    <label for="buyPrice"><i class="fas fa-arrow-down"></i> Buy Price ($)</label>
                    <input type="number" id="buyPrice" placeholder="Price per coin when buying" value="0">
                </div>
                
                <div class="input-group">
                    <label for="sellPrice"><i class="fas fa-arrow-up"></i> Sell Price ($)</label>
                    <input type="number" id="sellPrice" placeholder="Price per coin when selling" value="0">
                </div>
                ...
                <p class="disclaimer">
                    Disclaimer: This calculator is for illustrative purposes only. Cryptocurrency investments are subject to high market risk. The information provided is not financial advice.
                </p>
            </div>
